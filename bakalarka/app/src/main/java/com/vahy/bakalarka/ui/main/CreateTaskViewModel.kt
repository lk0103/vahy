...
import com.vahy.bakalarka.tasks.ControlTasks
...
import com.vahy.vahy.equation.Multiplication
import com.vahy.vahy.equation.Variable
...
class CreateTaskViewModel : ViewModel() {
    ...
    fun generateEquation() {
        ...
        scalesView.setSolutionBuild(mutableMapOf())
