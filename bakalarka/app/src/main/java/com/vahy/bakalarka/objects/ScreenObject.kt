...
import com.vahy.bakalarka.objects.ScaleValue
...
open class ScreenObject(var dragFrom : Boolean, var dragTo : Boolean){
    ...
    open fun returnPackages() : MutableList<com.vahy.bakalarka.objects.Package> = mutableListOf()
    ...
    open fun incrementValue(x1 : Int, y1 : Int) : EquationObject?{
        ...
        if (clickedObject is com.vahy.bakalarka.objects.Package){
            return clickedObject
        }
        return null
    }
