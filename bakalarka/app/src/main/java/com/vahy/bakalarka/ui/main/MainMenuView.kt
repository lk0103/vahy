...
import com.vahy.bakalarka.objects.menu.CreateTaskIcon
import com.vahy.bakalarka.objects.menu.Icon
...
class MainMenuView(context: Context, attrs: AttributeSet)
    ...
    private val objForHolders = listOf(
        ...
        Pair(listOf(com.vahy.bakalarka.objects.Package(context),
                    com.vahy.bakalarka.objects.Package(context)),
